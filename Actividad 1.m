...
GDL= size(RP,2);%SIEMPRE SE COLOCAN 2 POR QUE INDICA LA DIMENCIÓN DE LAS COLUMNAS
GDL_str= num2str(GDL);
...
R(:,:,1)= [cos(th1) -sin(th1)  0;%Analisis de robot péndulo
           sin(th1)  cos(th1)  0;
           0         0         1];
...
P(:,:,2)= [a2*cos(th2); 
           a2*sin(th2);
                    0];
%Matriz de rotación de la junta 1 respecto a 0
R(:,:,2)= [cos(th2) -sin(th2)  0;%Analisis de robot péndulo
           sin(th2)  cos(th2)  0;
           0         0         1];
...
P(:,:,3)= [a3*cos(th3); 
           a3*sin(th3);
                    0];
%Matriz de rotación de la junta 1 respecto a 0
R(:,:,3)= [cos(th3) -sin(th3)  0;%Analisis de robot péndulo
           sin(th3)  cos(th3)  0;
           0         0         1];
